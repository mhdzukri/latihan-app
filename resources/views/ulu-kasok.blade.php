        ...
        <div class="max-w-5xl m-auto">
            <div class="relative">
                <div class="absolute w-full h-full flex flex-col items-center justify-center space-y-10 bg-black/40">
                    <h1 class="montserrat text-4xl text-white font-bold">Mulai Petualanganmu Dari Puncak</h1>
                    <img src="{{ asset('assets/img/ulu-kasok.png') }}" alt="ulu-kasok" class="w-100">
                    <div class="flex items-center mt-20 space-x-4">
                        ...
                        @endauth
                        <button
                            class="bg-none text-white border-white border-2 font-bold rounded-full px-6 py-3 cursor-pointer hover:scale-96 duration-150">Explore</button>
                </div>
            </div>
...
<section>
    <div class="max-w-5xl mx-auto my-10">
        <h1 class="text-center text-3xl montserrat text-[#142e50] font-bold">Tingkatkan Pengalaman Liburan Anda di
            Ulu Kasok</h1>
        <p class="text-center text-[#696969] mt-5 mb-10">Jelajahi Keindahan Ulu Kasok, Surga Tersembunyi di Kampar
        </p>
        <div class="space-y-20">

            @foreach ($todoPosts as $todoPost)
                <div class="grid grid-cols-2 gap-15 items-center">
                    <div class="space-y-10 {{ $loop->iteration % 2 == 0 ? 'order-end' : '' }}">
                    ...
                    <div class="rounded-xl overflow-hidden {{ $loop->iteration % 2 == 0 ? 'order-first' : '' }}">
...
<section class="bg-[#eee]">
    <div class="max-w-5xl mx-auto bg-[#eeeeee] py-10">
