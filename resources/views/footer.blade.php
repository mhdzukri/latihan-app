        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-10 w-xs sm:w-sm md:w-3xl lg:w-5xl max-w-5xl mx-auto">
            <div class="flex flex-col items-center grid-row-3 py-10">
                ...
                <div class="mb-20 flex justify-between w-full text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" class="size-7 "
                        fill="currentColor"><!--!Font Awesome Free v7.0.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2025 Fonticons, Inc.-->
                        <path
            ...
            <div class="col-span-2 hidden md:flex justify-between space-x-5 ml-10">
                <div class="py-15 text-center w-fit space-y-3">
                    ...
                    <p><a href="#" class="text-white font-bold text-sm">Galeri Foto & Video</a></p>
                </div>
                <div class="py-15 text-center w-fit space-y-3">
                    <h4 class="text-[#55C3EA] text-xl font-bold mb-5">Informasi</h4>
                    <p><a href="#" class="text-white font-bold text-sm">Tentang Ulu Kasok</a></p>
                    <p><a href="#" class="text-white font-bold text-sm">Tiket & Fasilitas</a></p>
                    <p><a href="#" class="text-white font-bold text-sm">Lokasi</a></p>
                </div>
                <div class="py-15 text-center w-fit space-y-3">
                    <h4 class="text-[#55C3EA] text-xl font-bold mb-5">Event</h4>
                    <p><a href="#" class="text-white font-bold text-sm">Acara & Festival</a></p>
                    <p><a href="#" class="text-white font-bold text-sm">Berita Terbaru</a></p>
                </div>
                <div class="py-15 text-center w-fit">
                    <h4 class="text-[#55C3EA] text-xl font-bold mb-5">Kontak</h4>
                    <p><a href="#" class="text-white font-bold text-sm">Hubungi Kami</a></p>
                </div>
            </div>
        </div>
    </footer>
