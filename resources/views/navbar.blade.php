    ...
    <nav
        class="fixed w-full top-0 z-10 bg-white after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10 shadow-lg">
        <div class="w-sm md:w-3xl lg:w-5xl mx-auto max-w-5xl">
